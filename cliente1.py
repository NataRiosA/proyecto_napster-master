...
def main():
    ...
    print("\n 1. Buscar por canción")
    print("\n 2. Buscar por artista")
    print("\n 3. Buscar por álbum") 
    print("\n 4. Salir") 
   
    while True:
        opcion = (input("Escriba el número de la opción para buscar: "))
        ...
        if opcion == "1":
            ...
            print(message)
            print ("- Nombre cancion:",songServer, "- artista:",artistServer,  "- duracion:",durationServer, "- tamaño:",sizeServer, "- usuario:",userServer)
            ...
            print("\nCliente conectando a cliente: ", userServer)
