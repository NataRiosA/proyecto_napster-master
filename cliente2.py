...
cliente = xmlrpc.client.ServerProxy('http://127.0.0.1:9798', allow_none=True)
...
def dataClient():
    ...
    global username
    username = "La_Haker" # input("Digita un nombre de usuario para identificarte en NAPSTER: ")
...
class clientThread(threading.Thread):
	...
	def run(self):
         username, host1, port1 = dataClient()
         ...
         cliente.listenClientData(username, host1, port1)
